...
png("results/figures/A1_CT_alt_UK.png", width = (1024*2), height = (768*2), units = 'px', res = 300)
...
pdf("results/figures/A2_CT_alt_US.pdf", width = 6.826666666666667, height = 5.12)
png("results/figures/A2_CT_alt_US.png", width = (1024*2), height = (768*2), units = 'px', res = 300)
ggplot(aes(x = period, y = cosine, color = cluster, group = cluster), 
...
pdf("results/figures/A3_CT_alt_full_US.pdf", width = 6.826666666666667, height = 5.12)
png("results/figures/A3_CT_alt_full_US.png", width = (1024*2), height = (768*2), units = 'px', res = 300)
ggplot(aes(x = period, y = cosine, color = cluster, group = cluster), 
...
## DistilBERT UK
pdf("results/figures/A4_distilBERT_UK.pdf", width = 6.826666666666667, height = 5.12)
png("results/figures/A4_distilBERT_UK.png", width = (1024*2), height = (768*2), units = 'px', res = 300)
ggplot(aes(x = period, y = cosine, color = cluster, group = cluster), 
...
## DistilBERT US
pdf("results/figures/A5_distilBERT_US.pdf", width = 6.826666666666667, height = 5.12)
png("results/figures/A5_distilBERT_US.png", width = (1024*2), height = (768*2), units = 'px', res = 300)
ggplot(aes(x = period, y = cosine, color = cluster, group = cluster), 
       data = subset(data, model == "DistilBERT Embeddings" & country == "US"
                     & cluster != "Corruption" & cluster != "Procedural - Judiciary (ext)" & cluster != "Procedural - Rules (ext)" & cluster != "Substantive - Democracy (ext)")) +
  geom_errorbar(aes(ymin = lower_ci, ymax = upper_ci), width = 0.2, position = position_dodge(0.3)) +
  geom_point(aes(shape = cluster), size = 1.5, position = position_dodge(0.3)) + 
  geom_line(aes(color = cluster, linetype = cluster), position = position_dodge(0.3), size = 0.5) +
...
## Chronologically Trained Model UK
pdf("results/figures/A6_CT_UK.pdf", width = 6.826666666666667, height = 5.12)
png("results/figures/A6_CT_UK.png", width = (1024*2), height = (768*2), units = 'px', res = 300)
ggplot(aes(x = period, y = cosine, color = cluster, group = cluster), 
       data = subset(data, model == "Chronologically Trained Model" & country == "UK"
...
## Chronologically Trained Model US
pdf("results/figures/A7_CT_US.pdf", width = 6.826666666666667, height = 5.12)
png("results/figures/A7_CT_US.png", width = (1024*2), height = (768*2), units = 'px', res = 300)
ggplot(aes(x = period, y = cosine, color = cluster, group = cluster), 
       data = subset(data, model == "Chronologically Trained Model" & country == "US"
                     & (cluster == "Substantive - Rights" | cluster == "Procedural - Judiciary (ext)" | cluster == "Procedural - Rules (ext)" | cluster == "Substantive - Democracy (ext)"))) +
  geom_errorbar(aes(ymin = lower_ci, ymax = upper_ci), width = 0.2, position = position_dodge(0.3)) +
...
## Chronologically Trained Model US full
pdf("results/figures/A8_CT_full_US.pdf", width = 6.826666666666667, height = 5.12)
png("results/figures/A8_CT_full_US.png", width = (1024*2), height = (768*2), units = 'px', res = 300)
ggplot(aes(x = period, y = cosine, color = cluster, group = cluster), 
       data = subset(data, model == "Chronologically Trained Model" & country == "US_full"
                     & (cluster == "Substantive - Rights" | cluster == "Procedural - Judiciary (ext)" | cluster == "Procedural - Rules (ext)" | cluster == "Substantive - Democracy (ext)"))) +
  geom_errorbar(aes(ymin = lower_ci, ymax = upper_ci), width = 0.2, position = position_dodge(0.3)) +
